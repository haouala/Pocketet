...
namespace PocketVeterinary
{
    ...
    public sealed partial class GuidePage : Page
    {
        ...
        /****************************/
        private void rabbitBtn_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(ParsingXml.RabbitPage));

        }

        private void hamsterBtn_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(ParsingXml.HamsterPage));

        }

        private void birdBtn_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(ParsingXml.BirdPage));

        }

        private void dogBtn_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(ParsingXml.DogPage));

        }

        private void catBtn_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(ParsingXml.CatPage));
        }
    }
}
