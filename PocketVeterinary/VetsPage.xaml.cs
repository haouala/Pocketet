...
namespace PocketVeterinary
{
    ...
    public sealed partial class VetsPage : Page
    {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            string url = "https://api.foursquare.com/v2/venues/explore/?venuePhotos=1&client_id=55F1QOARTVJYTKAT11J45VL4STLBGBPIAUMRUCXAP4MOZR0E&client_secret=KK5GFPLDSOSJINDLCK0DCYN5NSQD2E4G0HXQH2FCTW21RMY0&v=20160317&categoryId=4d954af4a243a5684765b473&ll={0},{1}";
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    if (response.response.groups != null)
                    {
                        ...
                        {
                            VetControl vetsControl = new VetControl();
                            vetsControl.Venue = j.venue;
                            gridVenues.Items.Add(vetsControl);
                        }
